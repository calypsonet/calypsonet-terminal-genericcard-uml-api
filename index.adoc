...
[[op_GenericCardTransactionManager_prepareCommand_apdu]]
...
[[op_GenericCardTransactionManager_prepareCommand_withId]]
...
[[op_GenericCardTransactionManager_prepareCommand_withDuration]]
